            	...
            	<div class="box-body box-profile">
            		...
            		<h4 class="profile-username text-left">Detail Keluhan</h4>
									<ul class="list-group  list-group-unbordered">
										...
										<?php echo '<p style="color:black"><b>RENDAH</b></p></a>'; ?>
											<?php elseif ($i->priority == 2) : ?><?php echo '<p style="color:orange;"><b>SEDANG</b></p></a>'; ?>
										<?php elseif ($i->priority == 3) : ?><?php echo '<p style="color:red;"><b>TINGGI</b></p></a>'; ?>
											<?php else : ?>
										<?php endif; ?>
										</a>
										</li>
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="masalah">
							...
							<br>
              		&emsp;&emsp;<blockquote class="blockquote mb-1"><p><?php echo $i->masalah; ?></p></blockquote>
							</div>
							<hr>
              ...
              <div class="tab-pane" id="comments">
							...
							<br>
							<?php else:?>
							<form class="form-horizontal" action="<?php echo base_url().'staff/keluhan/tambah_komentar'; ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="tab-pane" id="notes">
							...
							<br>
							<?php if ($idstk == $i->id_staff && (($i->status == '3' && $i->signmark_bykepbiro == '0')
                                                        || ($i->status == '2' && $i->signmark_bykepbiro == '0'))):?>
							<form class="form-horizontal" action="<?php echo base_url().'staff/keluhan_lanjut/update_detail_notes'; ?>" method="post" enctype="multipart/form-data">
							<hr>
							<div class="form-group">
								<div class="col-md-12">
									<input type="hidden" name="kode" value="<?php echo $i->id_keluhan; ?>">
      ...
      <div class="tab-pane" id="control-sidebar-home-tab">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'staff/keluhan/hapus_komentar'; ?>" method="post" enctype="multipart/form-data">
