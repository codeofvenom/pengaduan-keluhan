            ...
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                ...
                <button type="button" class="btn btn-box-tool btn" data-toggle="collapse"  data-target="#tambahkeluhan"><i class="fa fa-times" style="color:red"></i></button>
						...
						<form action="<?php echo base_url().'staff/keluhan/simpan_keluhan'; ?>" method="post" enctype="multipart/form-data">
											...
											<div class="col-md-4">
												...
												<div class="form-group">
													<label for="solusi">Solusi sementara dari pihak pengadu</label>	
														<textarea class="form-control" rows="3" name="xsolusi" placeholder="Solusi sementara untuk masalah yang dihadapi..."></textarea>
												</div>	
											</div>	
										</div>		
									</div>	
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="width:100%;font-size:12px;">
                ...
                <tr>
                    ...
                    <th style="width:15%">Pengadu Keluhan</th>
                ...
                <tr>
                 <td style="text-align:left;">
										 ...
										 <a href="<?php echo base_url().'staff/keluhan/detail/'.$i->id_keluhan; ?>">
											...
											<?php if ($i->id_staff == $idstk && $levls == $i->id_level) : ?>
    ...
    <strong> Copyright &copy; 2018  <a href="">Reinhart Joshua Utama - 672015116</strong></a>. All rights reserved.
							...
							<div class="modal fade" id="ModalEdit<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
									<div class="modal-dialog" role="document">
											<div class="modal-content">
													...
													<form class="form-horizontal" action="<?php echo base_url().'staff/keluhan/update_keluhan'; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'staff/keluhan/hapus_keluhan'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							<input type="hidden" name="kode" value="<?php echo $id; ?>"/>
	...
	<?php endforeach; ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'staff/keluhan/proses_maju'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							<input type="hidden" name="kode" value="<?php echo $id; ?>"/>
