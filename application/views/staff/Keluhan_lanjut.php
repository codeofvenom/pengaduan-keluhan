...
<head>
  ...
  <title>Sistem Pengaduan Keluhan Pegawai | Keluhan Lanjut</title>
							...
							<div class="modal fade" id="ModalEdit<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
									<div class="modal-dialog" role="document">
											<div class="modal-content">
													...
													<form class="form-horizontal" action="<?php echo base_url().'staff/keluhan_lanjut/update_keluhan'; ?>" method="post" enctype="multipart/form-data">
