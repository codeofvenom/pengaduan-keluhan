...
<div class="wrapper">
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Keluhan telah Selesai
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i> Home</a></li>
				<li class="active">Keluhan  telah Selesai</li>
      </ol>
    </section>
          ...
          <div class="box">
            <div class="box-header">
              <a class="text-black pull-left"><h4>Data Pengaduan Keluhan telah Selesai</h4></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="width:100%;font-size:12px;">
                ...
                <tr>
                    ...
                    <th style="width:20%">Status</th>
										<th style="width:25%">Kesimpulan/Solusi</th>
                 ...
                 <td style="text-align:left;">
										...
										<span data-toggle="tooltip" data-placement="top" data-original-title="Edit">
										 <a data-toggle="modal" data-target="#ModalEdit<?php echo $i->id_keluhan; ?>">
												...
												<?php elseif ($i->id_staff != $idstk && $levls == '2' && $i->id_level != '2' && $i->signmark_bykepbiro == '0') : ?>
										<span data-toggle="tooltip" data-placement="top" data-original-title="Edit">
										 <a data-toggle="modal" data-target="#ModalEdit<?php echo $i->id_keluhan; ?>">
												<button type="button" class="btn btn-info btn-xs" title="Edit"><i class="fa fa-pencil"></i></button>
											</a>
										</span>	
										<span data-toggle="tooltip" data-placement="top" data-original-title="Setujui">
										 <a data-toggle="modal" data-target="#ModalSetuju<?php echo $i->id_keluhan; ?>">
												<button type="button" class="btn btn-success btn-xs" title="Setujui"><i class="fa fa-check"></i></button>
											</a>
										</span>				
										<?php elseif ($i->id_staff != $idstk && $levls == '2' && $i->id_level != '2' && $i->signmark_bykepbiro == '1') : ?>
										<span data-toggle="tooltip" data-placement="top" data-original-title="Edit">
										 <a data-toggle="modal" data-target="#ModalEdit<?php echo $i->id_keluhan; ?>">
												<button type="button" class="btn btn-info btn-xs" title="Edit"><i class="fa fa-pencil"></i></button>
											</a>
                  ...
                  <td><?php echo $i->nama; ?></td>
                	 ...
                	 <td><?php if ($i->status == 3 && $i->signmark_bykepbiro == 0) : ?><?php echo '<p style="color:blue;"><b>KELUHAN TELAH SELESAI(PENDING) </b></p>'; ?>
												<?php else : ?><?php echo '<p style="color:blue;"><b>KELUHAN TELAH SELESAI</b><p>'; ?>
									<?php endif; ?>
									</td>
 ...
 <aside class="control-sidebar control-sidebar-dark">
    <div class="tab-content">
							...
							<div class="modal fade" id="ModalEdit<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
									<div class="modal-dialog" role="document">
											<div class="modal-content">
													...
													<form class="form-horizontal" action="<?php echo base_url().'kepbiro/keluhan_selesai/update_keluhan'; ?>" method="post" enctype="multipart/form-data">
                ...
                $tgl = $i['tanggal'];
                ?>
				<div class="modal fade" id="ModalSetuju<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Setujui Keluhan</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'kepbiro/keluhan_selesai/setuju_keluhan'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
														<input type="hidden" name="kode" value="<?php echo $id; ?>"/>
                            <p>Apakah Anda yakin mau menyetujui penyelesaian 
														keluhan dari staff Anda dengan judul <br><b><?php echo $jdl; ?></b> ?</p>
